...
// Detects illegal block placements using eye positions
// Previously named: PositionPlace
@CheckData(name = "Scaffold C")
public class ScaffoldC extends BlockPlaceCheck {

    public ScaffoldC(GrimPlayer player) {
        super(player);
    }
    ...
    public void onBlockPlace(BlockPlace place) {
        ...
        double movementThreshold = !player.packetStateData.didLastMovementIncludePosition
                || player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_9) ? player.getMovementThreshold() : 0;
