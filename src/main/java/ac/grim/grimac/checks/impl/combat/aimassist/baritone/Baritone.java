package ac.grim.grimac.checks.impl.combat.aimassist.baritone;
...
public class Baritone extends RotationCheck {
    ...
    public void process(RotationUpdate rotationUpdate) {
        ...
        if (rotationUpdate.getDeltaYaw() == 0 && deltaPitch > 0 && deltaPitch < 1 && Math.abs(to.getPitch()) != 90.0f) {
            long gcd = GrimMath.getGcd((long) (deltaPitch * GrimMath.EXPANDER), (long) (lastDeltaPitch * GrimMath.EXPANDER));
